...
export const InvitationsPage: React.FC<{ embedded?: boolean }> = ({ embedded = false }) => {
  const [open, setOpen] = useState(true);

  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6">
        {!embedded && <h1 className="font-display font-extrabold text-xl text-slate-900">Invitations</h1>}
