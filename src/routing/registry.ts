...
const teaching: CanonicalRouteDefinition[] = [
  ...
  route({ id: 'school.student-cbt', workspace: 'school', domain: 'assessment', capability: 'student.cbt', path: '/school/my-assessments', pageKey: 'cbt', access: cap('assessment.cbt.attempt'), breadcrumb: { label: 'My CBT Assessments', parentId: 'school.home' }, legacyNavIds: ['cbt'], visibility: 'student', classification: 'private', title: 'My CBT Assessments' }),
  route({ id: 'school.student-cbt.take', workspace: 'school', domain: 'assessment', capability: 'student.cbt.take', path: '/school/my-assessments/:assessmentPublicId/take', pageKey: 'cbt', params: [{ name: 'assessmentPublicId', kind: 'publicId', invalid: '404' }], access: cap('assessment.cbt.attempt'), breadcrumb: { label: 'Take assessment', parentId: 'school.student-cbt' }, visibility: 'student', classification: 'private', title: 'Take CBT assessment' }),
