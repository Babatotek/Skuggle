...
export const generatedQuestionKey = (
  section: 'objective' | 'theory',
  question: GeneratedMCQ | GeneratedTheory,
) => {
  const content = 'text' in question
    ? question.text
    : question.parts.map((part) => part.subQuestion).join('\u001f');
  return `assessment-question:${section}:${question.number}:${stableTextFingerprint(content.trim())}`;
};
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4 pt-1">
                        {generatedAssessment.sectionA.questions.map((q) => (
                          <div
                            key={generatedQuestionKey('objective', q)}
                    ...
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="space-y-4 pt-1">
                        {generatedAssessment.sectionB.questions.map((q) => (
                          <div
                            key={generatedQuestionKey('theory', q)}
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-100">
            ...
            <div className="flex items-center gap-2">
              ...
              {(currentRole === 'Principal' || currentRole === 'School Admin' || currentRole === 'Super Admin') && (
                <button
