...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'tenant', 'throttle:api'])->group(function (): void {
        ...
        Route::middleware(['verified', 'mfa'])->group(function (): void {
            ...
            Route::get('/assessment-questions', [\App\Http\Controllers\Api\V1\AssessmentQuestionController::class, 'index']);
            Route::post('/assessment-questions', [\App\Http\Controllers\Api\V1\AssessmentQuestionController::class, 'store'])->middleware('idempotency:required');
            Route::patch('/assessment-questions/{question}', [\App\Http\Controllers\Api\V1\AssessmentQuestionController::class, 'update'])->middleware('idempotency:required');
            ...
            Route::match(['get', 'put'], '/assessments/{assessment}/questions', [\App\Http\Controllers\Api\V1\AssessmentQuestionController::class, 'builder']);
