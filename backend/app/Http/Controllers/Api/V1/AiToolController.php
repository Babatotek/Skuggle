...
{
    public function assistant(Request $request, AIManager $ai): JsonResponse
    {
    ...
    public function assessment(Request $request, AIManager $ai): JsonResponse
    {
        $data = $request->validate(['assessmentType' => ['required', 'string', 'max:80'], 'subject' => ['required', 'string', 'max:120'], 'classLevel' => ['required', 'string', 'max:80'], 'topics' => ['required'], 'totalMarks' => ['required', 'integer', 'min:1', 'max:500'], 'timeAllowed' => ['nullable', 'string', 'max:80'], 'mcqCount' => ['nullable', 'integer', 'min:0', 'max:100'], 'theoryCount' => ['nullable', 'integer', 'min:0', 'max:50'], 'shortAnswerCount' => ['nullable', 'integer', 'min:0', 'max:50'], 'essayCount' => ['nullable', 'integer', 'min:0', 'max:20'], 'difficultyMix' => ['nullable', 'array'], 'regenerate' => ['sometimes', 'boolean'], 'difficulty' => ['nullable', 'string', 'max:40'], 'instructions' => ['nullable', 'string', 'max:2000']]);
