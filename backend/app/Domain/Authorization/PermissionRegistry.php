...
final class PermissionRegistry
{
    ...
    public static function definitions(): array
    {
        ...
        $rows = [
            ...
            ['assessment.assessment.update', 'assessment', 'assessment', 'update', 'Update draft assessments within assigned scope.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS', 'SPECIFIC_RESOURCE'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.assessment.schedule', 'assessment', 'assessment', 'schedule', 'Schedule an assessment for delivery.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS', 'SPECIFIC_RESOURCE'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.assessment.cancel', 'assessment', 'assessment', 'cancel', 'Cancel a planned assessment.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS', 'SPECIFIC_RESOURCE'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.question.view', 'assessment', 'question', 'view', 'View question bank items in assigned scope.', ['ASSIGNED_SUBJECTS', 'TENANT'], 'STANDARD', true, [], 'Assessment'],
            ['assessment.question.create', 'assessment', 'question', 'create', 'Create question bank drafts.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.question.update', 'assessment', 'question', 'update', 'Update question bank drafts.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.score.view', 'assessment', 'score', 'view', 'View assessment scores in assigned scope.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS', 'SPECIFIC_RESOURCE'], 'SENSITIVE', true, [], 'Assessment'],
            ['assessment.score.review', 'assessment', 'score', 'review', 'Review auto-marked and SmartMark scores.', ['ASSIGNED_CLASSES', 'ASSIGNED_SUBJECTS', 'SPECIFIC_RESOURCE'], 'SENSITIVE', true, [], 'Assessment'],
